 ...
 */
public class ConcurrenTestsRule implements TestRule {
     ...
     * Private constructor
     */
    private ConcurrenTestsRule() {
    }

    /**
     * Creates a new {@link ConcurrenTestsRule} with verbose tests
     *
     * @return newInstance of {@link ConcurrenTestsRule}
     */
    public static ConcurrenTestsRule verboseTests() {
        ConcurrenTestsRule newInstance = new ConcurrenTestsRule();
        newInstance.verbose = true;
        return newInstance;
    }

    /**
     * Creates a new {@link ConcurrenTestsRule} with silent tests
     *
     * @return newInstance of {@link ConcurrenTestsRule}
     */
    public static ConcurrenTestsRule silentTests() {
        ConcurrenTestsRule newInstance = new ConcurrenTestsRule();
